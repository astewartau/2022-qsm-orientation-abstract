...
fn.display_nii(mask_rotated, title=f'Mask (rotated {degrees[-1]}°)', cmap='gray', interpolation='nearest', slc=98)
fn.display_nii(qsm_rotated_average, title=f'QSM (rotated {degrees[-1]}°)', cmap='gray', vmin=-0.05, vmax=+0.05, interpolation='nearest', slc=98)
```

    Reconstructing QSM for 1° rotated images...
    Reconstructing QSM for 1° backsampled images...
    Reconstructing QSM for 2° rotated images...
    Reconstructing QSM for 2° backsampled images...
    Reconstructing QSM for 3° rotated images...
    Reconstructing QSM for 3° backsampled images...
    Reconstructing QSM for 4° rotated images...
    Reconstructing QSM for 4° backsampled images...
    Reconstructing QSM for 5° rotated images...
    Reconstructing QSM for 5° backsampled images...
    Reconstructing QSM for 10° rotated images...
    Reconstructing QSM for 10° backsampled images...
    Reconstructing QSM for 15° rotated images...
    Reconstructing QSM for 15° backsampled images...
    Reconstructing QSM for 20° rotated images...
    Reconstructing QSM for 20° backsampled images...
    Reconstructing QSM for 25° rotated images...
    Reconstructing QSM for 25° backsampled images...
    Reconstructing QSM for 30° rotated images...
    Reconstructing QSM for 30° backsampled images...
    Reconstructing QSM for 35° rotated images...
    Reconstructing QSM for 35° backsampled images...
    Reconstructing QSM for 40° rotated images...
    Reconstructing QSM for 40° backsampled images...
    Reconstructing QSM for 45° rotated images...
    Reconstructing QSM for 45° backsampled images...



    
![png](abstract-code_files/abstract-code_12_1.png)
    



    
![png](abstract-code_files/abstract-code_12_2.png)
...
![png](abstract-code_files/abstract-code_16_1.png)
